...
class ProbabilityDistribution<T extends Comparable<T>> {
     ...
     * @throws IllegalArgumentException if a number recieved from the generator
    ...
    public T pick(int index) {
        ...
        throw new RuntimeException(
                "Error in ProbabilityDistribution. Make sure to only add new records through " +
                        "record()"
        );
    }
    ...
    /**
     * @return a set containing all of the elements in the
     *         ProbabilityDistribution
     */
    public Set<T> keySet() {
